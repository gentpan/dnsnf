...
import { k as buildAssetsURL, u as useRuntimeConfig, m as getResponseStatusText, n as getResponseStatus, o as defineRenderHandler, s as publicAssetsURL, g as getQuery, c as createError, v as destr, w as getRouteRules, x as joinURL, y as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"DNS.NF is a minimal DNS lookup tool for fast and clean DNS queries."},{"name":"theme-color","content":"#ffffff"}],"link":[{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"},{"rel":"icon","type":"image/png","sizes":"32x32","href":"/favicon-32x32.png"},{"rel":"icon","type":"image/png","sizes":"16x16","href":"/favicon-16x16.png"},{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"manifest","href":"/site.webmanifest"},{"rel":"preconnect","href":"https://fonts.bluecdn.com"},{"rel":"stylesheet","href":"https://fonts.bluecdn.com/css2?family=Cairo+Play:wght@400;500;600;700;800&display=swap"},{"rel":"stylesheet","href":"https://flagcdn.io/css/flag-icons.min.css"},{"rel":"stylesheet","href":"https://icons.bluecdn.com/fontawesome-pro/css/all.min.css"}],"style":[],"script":[],"noscript":[],"title":"DNS.NF - Minimal DNS Lookup Tool"};
